...
export const MERCH_ITEMS: MerchItem[] = [
  ...
  {
    id: "hat-snapback",
    title: "Bob's Snapback",
    description: "Flat-brim snapback with bold front embroidery and star detail on the sides.",
    price: 32,
    category: "hat",
    image: "/merch/hat-snapback.jpg",
    availability: "in_stock",
    rating: 4.7,
    reviewCount: 23,
    shopifyUrl: "https://shop.bobssteakshoagies.com/products/snapback",
  },
  {
    id: "hat-beanie",
    title: "Bob's Beanie",
  ...
  // ── Hoodies ───────────────────────────────────────────────────────
  {
    ...
    price: 65,
    category: "hoodie",
    image: "/merch/hoodie-pullover-front.jpg",
    imageBack: "/merch/hoodie-pullover-back.jpg",
    availability: "in_stock",
  ...
  },
  {
    ...
    price: 72,
    category: "hoodie",
    image: "/merch/hoodie-zip-classic.jpg",
    availability: "in_stock",
    sizes: ["S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL"],
    rating: 4.9,
    reviewCount: 38,
  ...
  },
  {
    ...
    price: 78,
    category: "hoodie",
    image: "/merch/hoodie-zip-phillys-best.jpg",
    availability: "in_stock",
    sizes: ["S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL"],
    rating: 4.9,
    reviewCount: 22,
